...
test check: test_guidecoin FORCE
	./test_guidecoin
...
guidecoind: leveldb/libleveldb.a \
...
test_guidecoin: $(TESTOBJS) $(filter-out obj/init.o,$(OBJS:obj/%=obj/%))
	$(CXX) $(CFLAGS) -o $@ $(LIBPATHS) $^ $(LIBS) $(TESTLIBS)


clean:
	-rm -f guidecoind test_guidecoin
	-rm -f obj/*.o
	-rm -f obj-test/*.o
	-rm -f obj/*.P
	-rm -f obj-test/*.P
