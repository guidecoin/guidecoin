...
template<typename T>
std::string HeXGCr(const T itbegin, const T itend, bool fSpaces=false)
{
    std::string rv;
...
inline std::string HeXGCr(const std::vector<unsigned char>& vch, bool fSpaces=false)
{
    return HeXGCr(vch.begin(), vch.end(), fSpaces);
}

template<typename T>
void PrintHex(const T pbegin, const T pend, const char* pszFormat="%s", bool fSpaces=true)
{
    printf(pszFormat, HeXGCr(pbegin, pend, fSpaces).c_str());
}

inline void PrintHex(const std::vector<unsigned char>& vch, const char* pszFormat="%s", bool fSpaces=true)
{
    printf(pszFormat, HeXGCr(vch, fSpaces).c_str());
}
