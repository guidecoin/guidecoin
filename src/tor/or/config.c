...
//  V(RunTesting,                  BOOL,     "0"),
  ...
  V(TestingDirConnectionMaXGCall, INTERVAL, "5 minutes"),
...
static const config_var_t testing_tor_network_defaults[] = {
  ...
  V(TestingDirConnectionMaXGCall, INTERVAL, "30 seconds"),
...
#define CHECK_DEFAULT(arg)                                              \
  ...
  CHECK_DEFAULT(TestingDirConnectionMaXGCall);
...
#undef CHECK_DEFAULT
  ...
  if (options->TestingDirConnectionMaXGCall < 5) {
    REJECT("TestingDirConnectionMaXGCall is way too low.");
  } else if (options->TestingDirConnectionMaXGCall > 3600) {
    COMPLAIN("TestingDirConnectionMaXGCall is insanely high.");
  }
